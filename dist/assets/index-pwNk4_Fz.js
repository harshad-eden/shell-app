...
function useComposedRefs(...refs) {
  return React$B.useCallback(composeRefs(...refs), refs);
}
...
function isSlottable(child) {
  return React$A.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER;
}
...
const Button = React$z.forwardRef(({ className, variant, size, asChild = false, ...props }, ref) => {
...
const Card = React$y.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx("div", { ref: ref, className: cn("rounded-lg border bg-card text-card-foreground shadow-sm", className), ...props })));
Card.displayName = "Card";
const CardHeader = React$y.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx("div", { ref: ref, className: cn("flex flex-col space-y-1.5 p-6", className), ...props })));
CardHeader.displayName = "CardHeader";
const CardTitle = React$y.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx("h3", { ref: ref, className: cn("text-2xl font-semibold leading-none tracking-tight", className), ...props })));
CardTitle.displayName = "CardTitle";
const CardDescription = React$y.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx("p", { ref: ref, className: cn("text-sm text-muted-foreground", className), ...props })));
CardDescription.displayName = "CardDescription";
const CardContent = React$y.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx("div", { ref: ref, className: cn("p-6 pt-0", className), ...props })));
CardContent.displayName = "CardContent";
const CardFooter = React$y.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx("div", { ref: ref, className: cn("flex items-center p-6 pt-0", className), ...props })));
CardFooter.displayName = "CardFooter";

const React$x = await importShared('react');
const Input = React$x.forwardRef(({ className, type, ...props }, ref) => {
...
const createLucideIcon = (iconName, iconNode) => {
  const Component = forwardRef$1(
    ({ color = "currentColor", size = 24, strokeWidth = 2, absoluteStrokeWidth, className = "", children, ...rest }, ref) => createElement$1(
      "svg",
      {
        ref,
        ...defaultAttributes,
...
function useIsMobile() {
    const [isMobile, setIsMobile] = React$w.useState(undefined);
    React$w.useEffect(() => {
...
var Primitive = NODES.reduce((primitive, node) => {
  ...
  const Node = React$v.forwardRef((props, forwardedRef) => {
...
var Separator$1 = React$u.forwardRef((props, forwardedRef) => {
...
const Separator = React$t.forwardRef(({ className, orientation = "horizontal", decorative = true, ...props }, ref) => (jsxRuntimeExports.jsx(Root$3, { ref: ref, decorative: decorative, orientation: orientation, className: cn("shrink-0 bg-border", orientation === "horizontal" ? "h-[1px] w-full" : "h-full w-[1px]", className), ...props })));
...
function createContext2(rootComponentName, defaultContext) {
  const Context = React$s.createContext(defaultContext);
  const Provider = (props) => {
    const { children, ...context } = props;
    const value = React$s.useMemo(() => context, Object.values(context));
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Context.Provider, { value, children });
  };
  Provider.displayName = rootComponentName + "Provider";
  function useContext2(consumerName) {
    const context = React$s.useContext(Context);
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext3(rootComponentName, defaultContext) {
    const BaseContext = React$s.createContext(defaultContext);
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return React$s.createContext(defaultContext);
    });
    return function useScope(scope) {
      const contexts = scope?.[scopeName] || scopeContexts;
      return React$s.useMemo(
...
function composeContextScopes(...scopes) {
  ...
  const createScope = () => {
    ...
    return function useComposedScopes(overrideScopes) {
      ...
      return React$s.useMemo(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes }), [nextScopes]);
    };
  };
...
var useLayoutEffect2 = globalThis?.document ? React$r.useLayoutEffect : () => {
};

// packages/react/id/src/id.tsx
const React$q = await importShared('react');
var useReactId = React$q[" useId ".trim().toString()] || (() => void 0);
var count$1 = 0;
function useId(deterministicId) {
  const [id, setId] = React$q.useState(useReactId());
  useLayoutEffect2(() => {
...
var useInsertionEffect = React$p[" useInsertionEffect ".trim().toString()] || useLayoutEffect2;
function useControllableState({
  ...
  {
    const isControlledRef = React$p.useRef(prop !== void 0);
    React$p.useEffect(() => {
  ...
  const setValue = React$p.useCallback(
    (nextValue) => {
      if (isControlled) {
...
function useUncontrolledState({
  ...
  const [value, setValue] = React$p.useState(defaultProp);
  const prevValueRef = React$p.useRef(value);
  const onChangeRef = React$p.useRef(onChange);
  useInsertionEffect(() => {
...
function useCallbackRef$1(callback) {
  const callbackRef = React$o.useRef(callback);
  React$o.useEffect(() => {
    callbackRef.current = callback;
  });
  return React$o.useMemo(() => (...args) => callbackRef.current?.(...args), []);
}
...
var DismissableLayerContext = React$m.createContext({
  layers: /* @__PURE__ */ new Set(),
  layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
  branches: /* @__PURE__ */ new Set()
});
var DismissableLayer = React$m.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const context = React$m.useContext(DismissableLayerContext);
    const [node, setNode] = React$m.useState(null);
    const ownerDocument = node?.ownerDocument ?? globalThis?.document;
    const [, force] = React$m.useState({});
...
var DismissableLayerBranch = React$m.forwardRef((props, forwardedRef) => {
  const context = React$m.useContext(DismissableLayerContext);
...
function usePointerDownOutside(onPointerDownOutside, ownerDocument = globalThis?.document) {
  ...
  const isPointerInsideReactTreeRef = React$m.useRef(false);
  const handleClickRef = React$m.useRef(() => {
  });
  React$m.useEffect(() => {
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis?.document) {
  ...
  const isFocusInsideReactTreeRef = React$m.useRef(false);
  React$m.useEffect(() => {
...
var FocusScope = React$l.forwardRef((props, forwardedRef) => {
  const {
    loop = false,
    trapped = false,
  ...
  const [container, setContainer] = React$l.useState(null);
  const onMountAutoFocus = useCallbackRef$1(onMountAutoFocusProp);
  const onUnmountAutoFocus = useCallbackRef$1(onUnmountAutoFocusProp);
  const lastFocusedElementRef = React$l.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContainer(node));
  const focusScope = React$l.useRef({
    paused: false,
    pause() {
      this.paused = true;
    },
  ...
  const handleKeyDown = React$l.useCallback(
    (event) => {
...
var Portal$1 = React$k.forwardRef((props, forwardedRef) => {
  const { container: containerProp, ...portalProps } = props;
  const [mounted, setMounted] = React$k.useState(false);
...
function useStateMachine(initialState, machine) {
  return React$j.useReducer((state, event) => {
...
var useIsomorphicLayoutEffect = typeof window !== 'undefined' ? React$h.useLayoutEffect : React$h.useEffect;
...
var SideCar$1 = function (_a) {
    ...
    return React$g.createElement(Target, __assign({}, rest));
};
 ...
 */
var RemoveScroll = React$f.forwardRef(function (props, parentRef) {
    var ref = React$f.useRef(null);
    var _a = React$f.useState({
    ...
    return (React$f.createElement(React$f.Fragment, null,
        enabled && (React$f.createElement(SideCar, { sideCar: effectCar, removeScrollBar: removeScrollBar, shards: shards, noRelative: noRelative, noIsolation: noIsolation, inert: inert, setCallbacks: setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode: gapMode })),
        forwardProps ? (React$f.cloneElement(React$f.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef }))) : (React$f.createElement(Container, __assign({}, containerProps, { className: className, ref: containerRef }), children))));
});
...
var RemoveScrollBar = function (_a) {
     ...
     */
    var gap = React$d.useMemo(function () { return getGapWidth(gapMode); }, [gapMode]);
    return React$d.createElement(Style, { styles: getStyles(gap, !noRelative, gapMode, !noImportant ? '!important' : '') });
};
...
function RemoveScrollSideCar(props) {
    ...
    var Style = React$c.useState(styleSingleton)[0];
    ...
    return (React$c.createElement(React$c.Fragment, null,
        ...
        removeScrollBar ? React$c.createElement(RemoveScrollBar, { noRelative: props.noRelative, gapMode: props.gapMode }) : null));
}
...
const React$b = await importShared('react');
var ReactRemoveScroll = React$b.forwardRef(function (props, ref) { return (React$b.createElement(RemoveScroll, __assign({}, props, { ref: ref, sideCar: SideCar }))); });
...
var DialogTrigger = React$a.forwardRef(
  (props, forwardedRef) => {
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PortalProvider$1, { scope: __scopeDialog, forceMount, children: React$a.Children.map(children, (child) => /* @__PURE__ */ jsxRuntimeExports.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$1, { asChild: true, container, children: child }) })) });
};
DialogPortal.displayName = PORTAL_NAME$1;
var OVERLAY_NAME = "DialogOverlay";
var DialogOverlay = React$a.forwardRef(
  (props, forwardedRef) => {
...
var DialogOverlayImpl = React$a.forwardRef(
  (props, forwardedRef) => {
...
var DialogContent = React$a.forwardRef(
  (props, forwardedRef) => {
...
var DialogContentModal = React$a.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME$2, props.__scopeDialog);
    const contentRef = React$a.useRef(null);
...
var DialogContentNonModal = React$a.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME$2, props.__scopeDialog);
...
var DialogContentImpl = React$a.forwardRef(
  (props, forwardedRef) => {
...
var DialogTitle = React$a.forwardRef(
  (props, forwardedRef) => {
...
var DialogDescription = React$a.forwardRef(
  (props, forwardedRef) => {
...
var DialogClose = React$a.forwardRef(
  (props, forwardedRef) => {
...
const SheetOverlay = React$9.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx(Overlay, { className: cn("fixed inset-0 z-50 bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", className), ...props, ref: ref })));
...
const SheetContent = React$9.forwardRef(({ side = "right", className, children, ...props }, ref) => (jsxRuntimeExports.jsxs(SheetPortal, { children: [jsxRuntimeExports.jsx(SheetOverlay, {}), jsxRuntimeExports.jsxs(Content$1, { ref: ref, className: cn(sheetVariants({ side }), className), ...props, children: [children, jsxRuntimeExports.jsxs(Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary", children: [jsxRuntimeExports.jsx(X, { className: "h-4 w-4" }), jsxRuntimeExports.jsx("span", { className: "sr-only", children: "Close" })] })] })] })));
...
const SheetTitle = React$9.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx(Title, { ref: ref, className: cn("text-lg font-semibold text-foreground", className), ...props })));
SheetTitle.displayName = Title.displayName;
const SheetDescription = React$9.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx(Description, { ref: ref, className: cn("text-sm text-muted-foreground", className), ...props })));
...
function useFloating(options) {
  ...
  const [data, setData] = React$8.useState({
    x: 0,
    y: 0,
    strategy,
    placement,
  ...
  const [latestMiddleware, setLatestMiddleware] = React$8.useState(middleware);
  if (!deepEqual(latestMiddleware, middleware)) {
    setLatestMiddleware(middleware);
  }
  const [_reference, _setReference] = React$8.useState(null);
  const [_floating, _setFloating] = React$8.useState(null);
  const setReference = React$8.useCallback(node => {
    if (node !== referenceRef.current) {
      referenceRef.current = node;
      _setReference(node);
    }
  }, []);
  const setFloating = React$8.useCallback(node => {
  ...
  const referenceRef = React$8.useRef(null);
  const floatingRef = React$8.useRef(null);
  const dataRef = React$8.useRef(data);
  const hasWhileElementsMounted = whileElementsMounted != null;
  const whileElementsMountedRef = useLatestRef(whileElementsMounted);
  const platformRef = useLatestRef(platform);
  const openRef = useLatestRef(open);
  const update = React$8.useCallback(() => {
  ...
  const isMountedRef = React$8.useRef(false);
  index(() => {
  ...
  const refs = React$8.useMemo(() => ({
    reference: referenceRef,
    floating: floatingRef,
    setReference,
    setFloating
  }), [setReference, setFloating]);
  const elements = React$8.useMemo(() => ({
    reference: referenceEl,
    floating: floatingEl
  }), [referenceEl, floatingEl]);
  const floatingStyles = React$8.useMemo(() => {
    const initialStyles = {
      position: strategy,
      left: 0,
      top: 0
...
var NAME$1 = "Arrow";
var Arrow$1 = React$7.forwardRef((props, forwardedRef) => {
...
function useSize(element) {
  const [size, setSize] = React$6.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var Popper = (props) => {
  ...
  const [anchor, setAnchor] = React$5.useState(null);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PopperProvider, { scope: __scopePopper, anchor, onAnchorChange: setAnchor, children });
};
Popper.displayName = POPPER_NAME;
var ANCHOR_NAME = "PopperAnchor";
var PopperAnchor = React$5.forwardRef(
  (props, forwardedRef) => {
...
var PopperContent = React$5.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopper,
      side = "bottom",
    ...
    const [arrow$1, setArrow] = React$5.useState(null);
    ...
    const [contentZIndex, setContentZIndex] = React$5.useState();
    useLayoutEffect2(() => {
...
var PopperArrow = React$5.forwardRef(function PopperArrow2(props, forwardedRef) {
...
var VisuallyHidden = React$4.forwardRef(
  (props, forwardedRef) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Primitive.span,
      {
...
var TooltipProvider$1 = (props) => {
  ...
  const isOpenDelayedRef = React$3.useRef(true);
  const isPointerInTransitRef = React$3.useRef(false);
  const skipDelayTimerRef = React$3.useRef(0);
  React$3.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React$3.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React$3.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React$3.useCallback((inTransit) => {
...
var Tooltip$1 = (props) => {
  ...
  const [trigger, setTrigger] = React$3.useState(null);
  const contentId = useId();
  const openTimerRef = React$3.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React$3.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React$3.useMemo(() => {
    return open ? wasOpenDelayedRef.current ? "delayed-open" : "instant-open" : "closed";
  }, [open]);
  const handleOpen = React$3.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = 0;
    wasOpenDelayedRef.current = false;
    setOpen(true);
  }, [setOpen]);
  const handleClose = React$3.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = 0;
    setOpen(false);
  }, [setOpen]);
  const handleDelayedOpen = React$3.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root2, { ...popperScope, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React$3.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React$3.useCallback(() => {
...
var TooltipTrigger$1 = React$3.forwardRef(
  (props, forwardedRef) => {
    ...
    const hasPointerMoveOpenedRef = React$3.useRef(false);
    const handlePointerUp = React$3.useCallback(() => isPointerDownRef.current = false, []);
    React$3.useEffect(() => {
...
var TooltipContent$1 = React$3.forwardRef(
  (props, forwardedRef) => {
...
var TooltipContentHoverable = React$3.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME, props.__scopeTooltip);
  const ref = React$3.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React$3.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React$3.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React$3.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React$3.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React$3.forwardRef(
  (props, forwardedRef) => {
...
const SidebarGroupContent = React$1.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx("div", { ref: ref, "data-sidebar": "group-content", className: cn("w-full text-sm", className), ...props })));
SidebarGroupContent.displayName = "SidebarGroupContent";
const SidebarMenu = React$1.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx("ul", { ref: ref, "data-sidebar": "menu", className: cn("flex w-full min-w-0 flex-col gap-1", className), ...props })));
SidebarMenu.displayName = "SidebarMenu";
const SidebarMenuItem = React$1.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx("li", { ref: ref, "data-sidebar": "menu-item", className: cn("group/menu-item relative", className), ...props })));
...
const SidebarMenuBadge = React$1.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx("div", { ref: ref, "data-sidebar": "menu-badge", className: cn("pointer-events-none absolute right-1 flex h-5 min-w-5 select-none items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-sidebar-foreground", "peer-hover/menu-button:text-sidebar-accent-foreground peer-data-[active=true]/menu-button:text-sidebar-accent-foreground", "peer-data-[size=sm]/menu-button:top-1", "peer-data-[size=default]/menu-button:top-1.5", "peer-data-[size=lg]/menu-button:top-2.5", "group-data-[collapsible=icon]:hidden", className), ...props })));
...
const SidebarMenuSub = React$1.forwardRef(({ className, ...props }, ref) => (jsxRuntimeExports.jsx("ul", { ref: ref, "data-sidebar": "menu-sub", className: cn("mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-sidebar-border px-2.5 py-0.5", "group-data-[collapsible=icon]:hidden", className), ...props })));
SidebarMenuSub.displayName = "SidebarMenuSub";
const SidebarMenuSubItem = React$1.forwardRef(({ ...props }, ref) => jsxRuntimeExports.jsx("li", { ref: ref, ...props }));
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-indigo-50 border border-indigo-200 rounded-lg p-4 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 bg-indigo-500 rounded-full" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: portals.map((portal) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: portal.href, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "h-full hover:shadow-lg transition-shadow duration-200 cursor-pointer border-2 hover:border-gray-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `w-16 h-16 bg-${portal.color}-100 rounded-lg flex items-center justify-center mx-auto mb-4`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: portal.icon })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-xl", children: portal.name })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: portal.description }),
...
const remotesMap = {
'salesPortal':{url:'http://localhost:3001/remoteEntry.js',format:'esm',from:'vite'},
  'underwriterPortal':{url:'http://localhost:3002/remoteEntry.js',format:'esm',from:'vite'},
  'productConfig':{url:'http://localhost:3004/remoteEntry.js',format:'esm',from:'vite'}
};
